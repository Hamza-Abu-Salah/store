$(document).ready(function () {
    ...
    function Do_Add_new_active_invoice(){
        ...
        jQuery.ajax({
            ...
            data: {
                ...
                is_has_customer: is_has_customer, delegate_code: delegate_code, pill_type: pill_type, sales_item_type_main: sales_item_type_main,
    ...
    //   (enter)معناها عند الضغط على <-keypress
