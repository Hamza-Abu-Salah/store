...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('sales_invoices', function (Blueprint $table) {
            ...
            $table->decimal('delegate_commission_percent'); //نسبة عمولة المندوب
            $table->decimal('delegate_commission_value'); //قيمةعمولة المندوب
            $table->decimal('delegate_commission_percent_type');
            ...
            $table->date('date');
            $table->tinyInteger('sales_item_type');
