...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('inv_production_receive_details', function (Blueprint $table) {
            $table->id();
            $table->bigInteger('inv_production_receive_id');
            $table->bigInteger('inv_production_receive_auto_serial');
    ...
    {
        Schema::dropIfExists('inv_production_receive_details');
    }
};
