...
class Treasuries_transaction extends Model
{
    ...
    protected $fillable = [
        'treasuries_id', 'money', 'mov_type', 'the_foregin_key', 'date', 'last_update', 'added_by', 'updated_by', 'come_code', 'ac_yearly_trn_ENTRY_NO', 'account_number', 'is_account',
        ...
        'move_section', 'move_date', 'shift_code', 'isal_number', 'is_approved', 'auto_serial','admin_shift_id'
    ];
}
