...
<body style="padding-top: 10px;font-family: tahoma;">
    <table cellspacing="0" style="width: 30%; margin-right: 5px; float: right;  border: 1px dashed black " dir="rtl">
        <tr>
            <td style="padding: 5px; text-align: right;font-weight: bold;"> تاريخ امر الجرد <span
                    style="margin-right: 10px;">/ {{ $data['inventory_date'] }}</span></td>
        </tr>

        <tr>
            <td style="padding: 5px; text-align: right;font-weight: bold;"> مخزن الجرد <span
        ...
        <tr>
            <td style="padding: 5px; text-align: right;font-weight: bold;"> حالة امر الجرد <span
                    style="margin-right: 10px;">/ @if ($data['is_closed'] == 1)
                        مغلق ومرحل
                    @else
                        مفتوح
                    @endif
