                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="production_lines_parent_account" id="production_lines_parent_account"
                                    class="form-control select2">
                                    <option value="">اختر الحساب </option>
                                    @if (@isset($parent_accounts) && !@empty($parent_accounts))
                                        @foreach ($parent_accounts as $info)
                                            <option @if (old('production_lines_parent_account', $data['production_lines_parent_account']) == $info->account_number) selected="selected" @endif
                                                value="{{ $info->account_number }}"> {{ $info->name }} </option>
                                        @endforeach
                                    @endif
                                </select>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="image">
                                    <img class="custom_img" src="{{ asset('uploads') . '/' . $data['photo'] }}"
                                        alt="لوجو الشركة">
...
@section('script')
    ...
    <script src="{{ asset('adminassets/js/collect_transaction.js') }}"></script>
