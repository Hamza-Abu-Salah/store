                ...
                <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if ($data['is_approved'] == 0)
                                            <a href="{{ route('admin.inv_stores_transfer.delete', $data['id']) }}"
                                                class="btn btn-sm are_you_shue  btn-danger">حذف</a>
                                            <a href="{{ route('admin.inv_stores_transfer.edit', $data['id']) }}"
                    ...
                    <div class="card-header">
                        ...
                        <input type="hidden" id="ajax_get_item_uoms_url"
                            value="{{ route('admin.inv_stores_transfer.get_item_uoms') }}">
                        <input type="hidden" id="ajax_Add_item_to_invoice"
                            value="{{ route('admin.inv_stores_transfer.Add_item_to_invoice') }}">
                        <input type="hidden" id="ajax_reload_itemsdetials"
                            value="{{ route('admin.inv_stores_transfer.reload_itemsdetials') }}">
                        <input type="hidden" id="ajax_reload_parent_pill"
                            value="{{ route('admin.inv_stores_transfer.reload_parent_pill') }}">
                        <input type="hidden" id="ajax_load_edit_item_details"
                            value="{{ route('admin.inv_stores_transfer.load_edit_item_details') }}">
                        <input type="hidden" id="ajax_load_modal_add_details"
                            value="{{ route('admin.inv_stores_transfer.load_modal_add_details') }}">
                        <input type="hidden" id="ajax_edit_item_details"
                            value="{{ route('admin.inv_stores_transfer.edit_item_details') }}">
                        <input type="hidden" id="ajax_load_modal_approve_invoice"
                            value="{{ route('admin.inv_stores_transfer.load_modal_approve_invoice') }}">
                        <input type="hidden" id="ajax_load_usershiftDiv"
                            value="{{ route('admin.inv_stores_transfer.load_usershiftDiv') }}">
                        <input type="hidden" id="ajax_get_item_batches"
                            value="{{ route('admin.inv_stores_transfer.get_item_batches') }}">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($info->is_approved == 0 and $data['is_approved'] == 0)
                                                    <a href="{{ route('admin.inv_stores_transfer.delete_details', ['id' => $info->id, 'id_parent' => $data['id']]) }}"
                                                        class="btn btn-sm are_you_shue   btn-danger">حذف</a>
                                                @endif
                                            </td>
                                        </tr>
...
@section('script')
    ...
    <script src="{{ asset('adminassets/js/inv_stores_transfer.js') }}"></script>
@endsection
