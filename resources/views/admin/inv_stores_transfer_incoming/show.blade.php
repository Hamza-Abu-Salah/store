                ...
                <div class="card-body">
                    <div id="ajax_responce_serarchDivparentpill">
                        <input type="hidden" id="ajax_load_cancel_one_details"
                            value="{{ route('admin.inv_stores_transfer_incoming.load_cancel_one_details') }}">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($info->is_approved == 0 and $data['is_approved'] == 0 and $info->is_canceld_receive == 0)
                                                    <a href="{{ route('admin.inv_stores_transfer_incoming.approve_one_details', ['id' => $info->id, 'id_parent' => $data['id']]) }}"
