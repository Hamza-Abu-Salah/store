    ...
    <div class="card">
        <div class="card-header">
            ...
            <input type="hidden" id="ajax_search_url"
                value="{{ route('admin.inv_stores_transfer_incoming.ajax_search') }}">
        </div>
        <!-- /.card-header -->
        <div class="card-body">
            <div class="row">
                                    ...
                                    @foreach ($data as $info)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('admin.inv_stores_transfer_incoming.show', $info->id) }}"
                                                    class="btn btn-sm   btn-info">التفاصيل</a>
                                                <a style="font-size: .875rem; padding: 0.25rem 0.5rem;color:white"
                                                    target="_blank"
                                                    href="{{ route('admin.inv_stores_transfer_incoming.printsaleswina4', [$info->id, 'A4']) }}"
                                                    class="btn btn-primary btn-xs"> WA4</a>
                                                <a style="font-size: .875rem; padding: 0.25rem 0.5rem;color:white"
                                                    target="_blank"
                                                    href="{{ route('admin.inv_stores_transfer_incoming.printsaleswina4', [$info->id, 'A6']) }}"
...
@endsection
@section('script')
    <script src="{{ asset('adminassets/js/inv_stores_transfer_incoming.js') }}"></script>
