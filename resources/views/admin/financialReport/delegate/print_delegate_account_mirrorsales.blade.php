        ...
        <tr>
            <td style="text-align:left !important;padding: 5px;">
                <img style="width: 150px; height: 110px; border-radius: 10px;"
                    src="{{ asset('uploads') . '/' . $systemData['photo'] }}">
        ...
        <tr>
            ...
            <td style="width: 75%;text-align: right; padding-right: 5px; ">
                @if ($data['start_balance'] > 0)
                    مدين ب ({{ $data['start_balance'] * 1 }}) شيكل
                @elseif ($data['start_balance'] < 0)
                    دائن ب ({{ $data['start_balance'] * 1 * -1 }}) شيكل
                @else
                    متزن
                @endif
            </td>
        ...
        <tr>
            ...
            <td style="width: 75%;text-align: right; padding-right: 5px; ">
                @if ($data['the_final_Balance'] > 0)
                    مدين ب ({{ $data['the_final_Balance'] * 1 }}) شيكل
                @elseif ($data['the_final_Balance'] < 0)
                    دائن ب ({{ $data['the_final_Balance'] * 1 * -1 }}) شيكل
                @else
                    متزن
                @endif
            </td>
