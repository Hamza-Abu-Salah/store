                                                        ...
                                                        @foreach ($info->allBathces as $Det)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    بإجمالي تكلفة ( {{ $Det->total_cost_price * 1 }} شيكل )
                                                                    <br>
                                                                    بسعر ( {{ $Det->unit_cost_price * 1 }} شيكل ) لوحدة
                                                                    {{ $info->Uom_name }}
                                                                    @if ($info->does_has_retailunit == 1)
                                                                        ...
                                                                        ({{ $Det->total_cost_price * 1 }} شيكل) <br>
                                                                        بسعر ( {{ $Det->priceRetail * 1 }} شيكل ) لوحدة
...
@section('script')
    <script src="{{ asset('adminassets/js/itemcardBalance.js') }}"></script>
