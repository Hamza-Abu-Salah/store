            ...
            <div class="row">
                        ...
                        <select id="services_id_add" class="form-control select2" style="width: 100%;">
                            ...
                            @if (@isset($services) && !@empty($services))
                                @foreach ($services as $info)
                                    <option @if ($item_data_detials['service_id'] == $info->id) selected @endif
                ...
                <div class="col-md-4 ">
                    <div class="form-group">
                        ...
                        <input id="total_add" class="form-control" value="{{ $item_data_detials['total'] * 1 }}"
                ...
                <div class="col-md-12">
                    <div class="form-group text-center">
                        <button data-id="{{ $item_data_detials['id'] }}" type="button" class="btn btn-sm btn-danger"
                            id="EditDetailsItem">تعديل الخدمة</button>
                    </div>
                </div>
