                    ...
                    <table id="example2" class="table table-bordered table-hover">
                        <tr>
                            <td colspan="3">
                                ...
                                <input type="hidden" id="ajax_search_movements"
                                    value="{{ route('admin.inv_itemcard.ajax_search_movements') }}">
                        ...
                        <tr>
                            <td>
                                ...
                                {{ $data['inv_inv_itemcard_categories_name'] }}
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <div class="image">
                                    <img class="custom_img" src="{{ asset('adminassets/uploads') . '/' . $data['photo'] }}"
                                        alt="لوجو الشركة">
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                ...
                                <a href="{{ route('admin.inv_itemcard.edit', $data['id']) }}"
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="movements_categoriesMoveSearch" id="movements_categoriesMoveSearch"
                                ...
                                <option value="all">بحث بالكل </option>
                                @if (@isset($inv_inv_itemcard_movements_categories) && !@empty($inv_inv_itemcard_movements_categories))
                                    @foreach ($inv_inv_itemcard_movements_categories as $info)
                                        <option value="{{ $info->id }}"> {{ $info->name }} </option>
                                    @endforeach
                                @endif
                            </select>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="movements_typesMoveSearch" id="movements_typesMoveSearch"
                                class="form-control select2">
                                <option value="all">بحث بالكل </option>
                                @if (@isset($inv_inv_itemcard_movements_types) && !@empty($inv_inv_itemcard_movements_types))
                                    @foreach ($inv_inv_itemcard_movements_types as $info)
...
@section('script')
    <script src="{{ asset('adminassets/js/inv_itemcard.js') }}"></script>
