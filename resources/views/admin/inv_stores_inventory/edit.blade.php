                        ...
                        @if ($data['is_closed'] == 0)
                            <form action="{{ route('admin.stores_inventory.update', $data['id']) }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input readonly name="inventory_date" id="inventory_date" type="date"
                                        value="{{ old('inventory_date', $data['inventory_date']) }}" class="form-control">
                                    @error('order_date')
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="inventory_type" id="inventory_type" class="form-control">
                                        ...
                                        <option @if (old('inventory_type', $data['inventory_type']) == 1) selected="selected" @endif value="1">
                                            جرد يومي</option>
                                        <option @if (old('inventory_type', $data['inventory_type']) == 2) selected="selected" @endif value="2">
                                            جرد اسبوعي</option>
                                        <option @if (old('inventory_type', $data['inventory_type']) == 3) selected="selected" @endif value="3">
                                            جرد شهري</option>
                                        <option @if (old('inventory_type', $data['inventory_type']) == 4) selected="selected" @endif value="4">
                                            جرد سنوي</option>
                                    </select>
...
@endsection
@section('script')
    <script src="{{ asset('adminassets/js/services_with_orders.js') }}"></script>
